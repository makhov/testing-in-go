...
// TB START OMIT
// TB is the interface common to T and B. // HLTB
type TB interface {
	Error(args ...interface{})                 // HLERRFAT
	Errorf(format string, args ...interface{}) // HLERRFAT
	Fail()                                     // HLFAIL
	FailNow()                                  // HLFAIL
	Failed() bool
	Fatal(args ...interface{})                 // HLERRFAT
	Fatalf(format string, args ...interface{}) // HLERRFAT
	Log(args ...interface{})
	Logf(format string, args ...interface{})
	Name() string
	Skip(args ...interface{})                 // HLSKIP
	SkipNow()                                 // HLSKIP
	Skipf(format string, args ...interface{}) // HLSKIP
	Skipped() bool

	// A private method to prevent users implementing the // HLTBPR
	// interface and so future additions to it will not // HLTBPR
	// violate Go 1 compatibility. // HLTBPR
	private() // HLTBPR
}
